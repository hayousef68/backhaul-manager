...
# ====================================================================
#
#    🚀 Backhaul Manager v7.1 (Python - Final Stable Release) 🚀
#
#   This version contains all requested features and has been
#   cleaned to prevent any indentation or encoding errors.
#
# ====================================================================
...
def check_requirements():
    requirements = ['wget', 'tar', 'systemctl', 'openssl', 'jq', 'ss', 'pkill', 'curl']
    ...
    try:
        with open(os.path.join(TUNNELS_DIR, filename), 'r') as f:
            for line in f:
                ...
                if line.startswith("transport"): transport = line.split('=')[1].strip().strip('"')
...
def display_menu():
    ...
    colorize("Script Version: v7.1 (Python - Final Stable)", C.CYAN)
